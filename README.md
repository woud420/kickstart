...
- Implemented service extensions are intentionally narrow: Python/FastAPI, Rust, and TypeScript container services support Postgres, Redis, and JWT.
...
poetry run kickstart create service api-ts --lang typescript --database postgres --cache redis --auth jwt
