...
Implemented service extensions are intentionally narrow. Python/FastAPI, Rust, and TypeScript container services support Postgres, Redis, and JWT. Unsupported combinations fail instead of generating a partial or silent scaffold.
