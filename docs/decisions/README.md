...
This directory records durable project decisions for kickstart itself.
...
- [Architecture Evidence Pilot](architecture-evidence-pilot.md): why graph analysis remains a portable, report-only skill and the repository-local prototype was retired.
- [Docs Ownership Fences](docs-ownership-fences.md): host-format comment markers around managed docs regions, alternatives rejected, and the MDX caveat.
